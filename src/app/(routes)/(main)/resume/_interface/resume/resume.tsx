  ...
  if (error || !resume || !pdfUrl) {
    return (
      <Layout>
        <div className="relative container mx-auto px-4 py-8 min-h-screen">
          <section className="z-20 flex flex-col w-full justify-between mt-8 sm:mt-16 lg:mt-0 md:mt-0 mb-10 mx-auto">
            <Card className="w-full max-w-4xl mx-auto bg-gradient-to-br from-destructive/20 to-destructive/20 border-destructive rounded-xl overflow-hidden shadow-lg">
    ...
    <Layout>
      <div className="relative container mx-auto px-4 py-8 min-h-screen">
        <section className="z-20 flex flex-col w-full justify-between mt-8 sm:mt-16 lg:mt-0 md:mt-0 mb-10 mx-auto">
          ...
          >
            <Card className="w-full max-w-4xl mx-auto bg-card border-primary rounded-xl overflow-hidden shadow-lg hover:shadow-primary/20 transition-shadow duration-300">
              <CardContent className="p-4 sm:p-6">
