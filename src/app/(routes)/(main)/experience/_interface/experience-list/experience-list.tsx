  ...
  return (
    <div className="space-y-12">
      ...
      {experienceList && experienceList.length > 0 ? (
        <div className="relative max-w-6xl mx-auto">
          {/* Desktop timeline line */}
          <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary/50 via-primary to-primary/20 -translate-x-1/2 hidden lg:block" />
          {/* Mobile timeline line */}
          <div className="absolute left-2.5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary/50 via-primary to-primary/20 lg:hidden" />
  ...
  return (
    ...
    >
      <Card className="relative bg-card/50 backdrop-blur-sm border-border/50 rounded-xl overflow-hidden group hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300">
        {/* Accent gradient bar */}
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary/50 via-primary to-primary/50 group-hover:h-1.5 transition-all duration-300" />
          ...
          <div className="flex items-start gap-4">
            {item.logo && (
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="flex-shrink-0 w-14 h-14 relative bg-background rounded-xl overflow-hidden ring-2 ring-border/50 group-hover:ring-primary/50 transition-all duration-300 shadow-md"
              >
                <Image
