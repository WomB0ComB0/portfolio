  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-[#242424] text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <p className="mt-4 text-xl text-purple-200">Oops! The page you're looking for doesn't exist.</p>
        <Link href={'/'}>
          <Button
            className="mt-8 w-[200px] bg-transparent px-6 py-2 border border-purple-600 rounded-sm uppercase text-sm tracking-widest text-purple-400 transition-all hover:border-purple-600/40 hover:text-purple-400/40 hover:bg-transparent"
          >
            Go Home
          </Button>
        </Link>
