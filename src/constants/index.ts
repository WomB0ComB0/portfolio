...
export const Projects = [
  {
    name: 'Fribble',
    description: [
      'Used GraphQL and GrafBase (serverless GraphQL platform) to handle user storage, manage image uploads, which also had filtering functionality.',
      'Multi Page NextJS application, pagination, with routing & server-side rendering. Next Authentication (Google Authentication w/ GCP), Utilized JWT.',
      'Used React (Typescript), tailwind css, GraphQL, GrafBase, Next-Authentication and Vercel.',
    ],
  ...
  },
  {
    name: 'Creator Nebula',
    description: [
      'Application made to view and display creators, I did not want to make auth based ownership because that would mean I and to find a way to filter inappropriate content and implement authentication',
      'Implemented paginating, filtering, and sorting of data. Used Supabase for data storage and retrieval. Used ViteJS for bundling and PicoCSS for styling. Deployed on Vercel.',
    ],
  ...
  },
  {
    ...
    description: [
      'Developed a web app that uses voice and text responses for interview questions. Our AI grades your submission and offers advice for your current skill level and overall score.',
      'Researched and collected 140+ responses. Trained Python model with the Cohere API.',
      'Utilized Google Cloud’s speech-to-text API to support text submissions for accessibility.',
    ],
  ...
  },
  {
    name: 'Sweet Sobriety',
    description: [
      'Uses Web3 smart contracts to incentivize people in AA to attend their scheduled meetings.',
      'Our landing page is created on Velo by Wix and the Admin and User pages were made in React. Data was stored on Firebase(authentication).',
      'The smart contract was written on Solidity and the Polygon blockchain. The chatbot was created using Twilio (it needs tweaking, for unique messages).',
    ],
...
export const WorkExperience = [
  {
    ...
    endDate: 'Present',
    description: [
      'Collaborated with developers and designers tod optimize and develop upon UI/UX, existing and new code bases, and microservices. While using industry standard technologies.',
      'Developed skills in front-end and testing/debugging through practice and code reviews.',
      ' Gained valuable experience working in a fast-paced and dynamic environment, contributing to the successful delivery of multiple projects and initiatives.',
    ],
  },
  {
    ...
    endDate: 'Present',
    description: [
      "Developed and implemented user-friendly and accessible web designs for Think Round's ‘Center for the Human Family’, ensuring adherence to WCAG and UX best practices.",
      "Collaborated with the extended team to design and develop high-fidelity prototypes for ongoing projects, provided technical feedback on feasibility within the project's constraints.",
      'Web project management to ensure optimal execution of project tasks. Team leader of the full-stack developer team. We worked on each ‘floor’, developing the entire project.',
    ],
  },
  {
    ...
    endDate: 'Present',
    description: [
      "Maintained, and facilitated necessary changes. Oversaw the addition of new features and pages to improve UI/UX and functionality. Continually monitored the site's performance and analytics to identify areas for improvement and implement changes accordingly.",
      'Made certain we were WCAG 2.1, and 508 compliant. Improved, cross-platform compatibility, responsiveness, SEO w/ GSC, and edge-case PWA aspects.',
    ],
  },
  {
    ...
    endDate: 'Present',
    description: [
      'Actively attend meetings and engage in continuous learning, mastering technologies such as Flutter, Dart, MongoDB, and PHP with AWS.',
      'Contributed to projects by integrating UI/UX designs into web platforms, developing both desktop and mobile apps.',
      'Conducted application testing, ensured web quality assurance, and consistently maintained up-to-date documentation and research records.',
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      'Created applications using Next.js, Vite, React, Javascript, and Typescript. Improved SEO, implemented PWA, and used Netlify, Github Pages, and Vercel for hosting.',
      'Scraped the top 5 most recent GDSC events using Cheerio and cached results in a MongoDB database, to reduce the scraping needed for older events.',
    ],
  },
];

export const Buttons: Buttons[] = [{ name: 'About' }, { name: 'Experience' }, { name: 'Skills' }, { name: 'Projects' }];
...
export const resume =
  'https://docs.google.com/document/d/1ItV1Ugn87fBE8RvKji7_a5pZ8zbA59eZGVojnCoGiQA/edit?usp=sharing';
export const github = 'https://www.github.com/WomB0ComB0';
export const linkedin = 'https://www.linkedin.com/in/mikeodnis/';
export const styles = 'text-[#560BAD] h-7 w-7 animate-pulse';
