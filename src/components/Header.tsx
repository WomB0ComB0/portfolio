...
function Header({}: Props) {
  return (
    <header className='sticky top-0 z-20 flex justify-between p-5 mx-auto item-start max-w-7x1 xl:items-center'>
      ...
      <Link href='#contact'>
        <motion.div initial={{x: 500, opacity:0, scale: 0.5}} animate={{x:0,opacity:1, scale:1}} transition={{ duration: 1.5 }} className='flex-row items-center text-gray-300'>  
