...
export const MobileMenuOverlay: React.FC<MobileMenuOverlayProps> = memo(({ isOpen, onClose, pathname, query }) => {
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Navigation Content */}
            <nav className="flex flex-col gap-1.5 overflow-y-auto flex-1 p-4" role="navigation">
              {/* Home Link */}
              {home && (
                <Button
                  asChild
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  ...
                  <motion.div animate={{ rotate: professionalOpen ? 180 : 0 }} transition={{ duration: 0.2 }}>
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  ...
                  <motion.div animate={{ rotate: developerOpen ? 180 : 0 }} transition={{ duration: 0.2 }}>
                    <FiChevronDown size="1.1rem" className="text-muted-foreground" />
                  </motion.div>
                </Button>
