import type { CertificationItem, ExperienceItem } from '../types/sections';
...
export const experienceData: ExperienceItem[] = [
  {
    ...
    media: [
      {
        type: 'link',
        url: 'https://techinnovators.com/project-showcase',
        title: 'Project Showcase',
      },
      {
        type: 'image',
        url: '/assets/images/experience/tech-innovators-project.png',
        title: 'Main Project Screenshot',
      },
    ],
  },
  {
    ...
    media: [
      ...
      {
        type: 'image',
        url: '/assets/images/experience/contribution-graph.png',
        title: 'GitHub Contribution Graph',
      },
      {
        type: 'link',
        url: 'https://github.com/WomB0ComB0?tab=repositories',
  ...
  },
  {
    ...
    media: [
      ...
      {
        type: 'image',
        url: '/assets/images/experience/freelance-project-1.png',
        title: 'E-commerce Platform',
      },
      {
        type: 'image',
        url: '/assets/images/experience/freelance-project-2.png',
