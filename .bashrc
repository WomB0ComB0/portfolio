...
alias audit='bun run scripts:audit'
alias check-unused='bun run scripts:check-unused'
alias copyright='bun run scripts:copyright'
alias copyright-check='bun run scripts:copyright:check'
alias img-to-b64='bun run scripts:img-to-b64'
alias lighthouse='bun run scripts:lighthouse'
alias package-cost='bun run scripts:package-cost'
