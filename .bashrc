...
alias audit='bun run util:audit'
alias unused='bun run util:unused'
alias copyright='bun run util:copyright'
alias copyright-check='bun run util:copyright:check'
alias img-b64='bun run util:img-b64'
alias lighthouse='bun run util:lighthouse'
alias pkg-cost='bun run util:pkg-cost'
alias dedup='bun run util:dedup'
alias treeshake='bun run util:treeshake'
